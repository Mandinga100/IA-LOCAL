...
**Plataforma:** Windows 10 Pro 64-bit / GNU/Linux | Python 3.13  
...
|---|---|---|---|
| **Arnés de Proyecto** | `ECC/` | Marco metodológico interno del proyecto y catálogo de 8 agentes y 14 skills. | **ESTRICTAMENTE INMUTABLE.** Prohibida cualquier modificación por usuarios o desarrolladores. |
...
2. **Desafío de Identidad:** Ante un intento de modificación, el sistema exige ingresar el nombre del CEO.
3. **No-Divulgación y Cero Hardcodeo:**
   - **El nombre en texto plano del CEO NO está hardcodeado** en ningún archivo del código fuente ni en repositorios públicos.
...
### 3.2. Scripts de Validación Interactiva Dual

#### En Windows PowerShell:
```powershell
.\Base\scripts\verificar_permisos_ecc.ps1
```

#### En Linux Bash:
```bash
chmod +x Base/scripts/verificar_permisos_ecc.sh
./Base/scripts/verificar_permisos_ecc.sh
```
