...
PROFILES: Dict[ProfileType, TaskProfile] = {
    ...
    ProfileType.DOC_MAIN: TaskProfile(
        ...
        fallback_chain=["qwen2.5:7b", "qwen2.5:3b", "qwen2.5-coder:3b"],
        num_ctx=32768,
        temperature=0.2,
        top_p=0.9,
        num_predict=8192,
...
# Perfiles calibrados para MVP local (GTX 1650 4 GB VRAM + 16 GB RAM)
PROFILES_MVP: Dict[ProfileType, TaskProfile] = {
    ProfileType.DOC_FAST: TaskProfile(
        profile_type=ProfileType.DOC_FAST,
        label="Plataforma IA MVP - Ingesta Rápida (Qwen 7B / GTX 1650)",
        description="Corrección ortotipográfica de alta precisión y extracción rápida.",
        primary_model="qwen2.5:7b",
        secondary_model="qwen2.5:3b",
        safe_fallback_model="qwen2.5:3b",
        fallback_chain=["qwen2.5:3b"],
        num_ctx=16384,
        temperature=0.1,
        top_p=0.85,
        num_predict=4096,
        ...
        system_prompt=(
            "Eres un motor de procesamiento y corrección documental de alta fidelidad. "
            "Corrige únicamente errores gramaticales, tipográficos y de formato sin alterar "
            "el sentido ni omitir secciones originales. Todo el documento debe redactarse en español formal."
        ),
    ),
    ProfileType.DOC_MAIN: TaskProfile(
        profile_type=ProfileType.DOC_MAIN,
        label="Plataforma IA MVP - Síntesis y Redacción Enterprise (Qwen 7B / GTX 1650)",
        description="Estructuración documental, rehabilitación técnica y corrección de estilo senior.",
        primary_model="qwen2.5:7b",
        secondary_model="qwen2.5:3b",
        safe_fallback_model="qwen2.5:3b",
        fallback_chain=["qwen2.5:3b"],
        ...
        system_prompt=(
            "Eres un redactor y analista técnico senior. Genera salidas en Markdown estructurado "
            "con jerarquía semántica rigurosa, tablas y máxima claridad conceptual. "
            "100% en español técnico formal, sin preámbulos ni disculpas."
        ),
    ),
    ProfileType.DOC_DEEP: TaskProfile(
        profile_type=ProfileType.DOC_DEEP,
        label="Plataforma IA MVP - Razonamiento Analítico (Qwen 7B / GTX 1650)",
    ...
    ProfileType.CHAT_UI: TaskProfile(
        profile_type=ProfileType.CHAT_UI,
        label="Plataforma IA MVP - Asistente Conversacional (Qwen 7B / GTX 1650)",
    ...
    ProfileType.DOC_VLM: TaskProfile(
        profile_type=ProfileType.DOC_VLM,
        label="Plataforma IA MVP - Análisis Visual (Qwen2.5-VL 3B / GTX 1650)",
